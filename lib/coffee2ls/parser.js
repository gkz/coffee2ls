    ...
    parse: function(input, startRule) {
      ...
      function parse_memberExpression() {
        ...
        if (r3 === null) {
          ...
          if (r3 !== null) {
            r3 = (function(offset, line, column, ws0, e, args) { return gc(new CS.NewOp(e, args.operands[0]).r('new' + ws0 + e + args.raw).p(line, column, offset)); })(r4.offset, r4.line, r4.column, r7, r8, r9);
          }
          if (r3 === null) {
            pos = clone(r4);
          }
              ...
              if (r0 === null) {
                ...
                if (r0 === null) {
                  ...
                  if (r0 === null) {
                    ...
                    if (r0 !== null) {
                      r0 = (function(offset, line, column, r) { return gc((new CS.This).r(r).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
                    }
                    if (r0 === null) {
                      pos = clone(r1);
                    }
      ...
      function parse_ObjectInitialiserKeys() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, i) { return gc(new CS.Identifier(i).r(i).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_macro() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, r) { return gc(new CS.Int(line).r(r).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, r) { return gc(new CS.String(new Date().toDateString().slice(4)).r(r).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, r) { return gc(new CS.String(new Date().toTimeString().slice(0, 8)).r(r).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, r) { return gc(new CS.Int(+new Date).r(r).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
      ...
      function parse_bool() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, match) { return gc(new CS.Bool(true).r(match).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, match) { return gc(new CS.Bool(false).r(match).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_Numbers() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, bs) { return gc(new CS.Int(parseInt(bs.join(''), 2)).r("0b" + bs).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, os) { return gc(new CS.Int(parseInt(os.join(''), 8)).r("0o" + os).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r4);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, hs) { return gc(new CS.Int(parseInt(hs.join(''), 16)).r("0x" + hs).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r4);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
      ...
      function parse_string() {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, d) { return gc(new CS.String(d ? d.join('') : '').p(line, column, offset)); })(r1.offset, r1.line, r1.column, r4);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
      ...
      function parse_interpolation() {
        ...
        if (r0 === null) {
          ...
          if (r3 !== null) {
            ...
            if (r5 !== null) {
              r5 = (function(offset, line, column, d) { return gc(new CS.String(d.join('')).p(line, column, offset)); })(r6.offset, r6.line, r6.column, r5);
            }
            if (r5 === null) {
              pos = clone(r6);
            }
      ...
      function parse_interpolationPart() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, d) { return gc(new CS.String(d.join('')).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_regexp() {
        ...
        if (r3 !== null) {
          ...
          if (r5 !== null) {
            r5 = (function(offset, line, column) { return [gc(new CS.String('').g().p(line, column, offset))]; })(r6.offset, r6.line, r6.column);
          }
          if (r5 === null) {
            pos = clone(r6);
          }
          if (r5 === null) {
            ...
            if (r5 !== null) {
              r5 = (function(offset, line, column, s) { return [gc(new CS.String(s.join('')).g().p(line, column, offset))]; })(r6.offset, r6.line, r6.column, r5);
            }
            if (r5 === null) {
              pos = clone(r6);
            }
      ...
      function parse_hereregexpData() {
        ...
        if (r3 !== null) {
          ...
          if (r5 === null) {
            ...
            if (r5 !== null) {
              r5 = (function(offset, line, column, s) { return gc(new CS.String(s).p(line, column, offset)); })(r6.offset, r6.line, r6.column, r5);
            }
            if (r5 === null) {
              pos = clone(r6);
            }
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, c) { return [gc(new CS.String('\\' + c).p(line, column, offset))]; })(r1.offset, r1.line, r1.column, r4);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, s) { return [gc(new CS.String(s.join('')).p(line, column, offset))]; })(r1.offset, r1.line, r1.column, r0);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, c) { return [gc(new CS.String(c).p(line, column, offset))]; })(r1.offset, r1.line, r1.column, r3);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
      ...
      function parse_undefined() {
        ...
        r0 = parse_UNDEFINED();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (gc(new CS.Undefined).r('undefined').p(line, column, offset)); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_null() {
        ...
        r0 = parse_NULL();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (gc(new CS.Null).r('null').p(line, column, offset)); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_identifier() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, i) { return gc(new CS.Identifier(i).r(i).p(line, column, offset)); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
